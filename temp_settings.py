...
SECRET_KEY = 'django-insecure-7wk770gm_8@uz4a1k7g%xj)ydjhu_x1+xt!q%klj56#l)!d)1j'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'clinic_project/static')  # هذا هو المجلد الذي يحتوي على ملفات CSS و JS
]
